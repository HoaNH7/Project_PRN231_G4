...
namespace BookClient.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OrderDetailId,OrderId,BookId,UnitPrice,Quantity")] OrderDetail orderDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderDetailId,OrderId,BookId,UnitPrice,Quantity")] OrderDetail orderDetail)
        {
